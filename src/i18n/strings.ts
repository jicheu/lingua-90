...
const en = {
  ...
  "verbs.title": "Exercise 2 · Irregular verbs",
  "verbs.hint": "Fill the blank: {infinitive} ({translation})",
  "verbs.check": "Check",
  "verbs.next": "Next",
  "verbs.nice": "Correct!",
  "verbs.correctAnswer": "Correct answer",
  "verbs.perfect": "Perfect!",
  "verbs.tryAgain": "Almost there",
  "verbs.summary": "{correct} / {total} correct",
  "verbs.again": "Try again",
  "verbs.continue": "Continue",
  "verbs.noPool": "No verbs yet — come back tomorrow.",
  "verbs.tense.present": "present",
  "verbs.tense.past": "past",
  "verbs.tense.pastParticiple": "past participle",
  "verbs.tense.future": "future",
  "verbs.tense.presentPerfect": "present perfect",
  "verbs.tense.pastPerfect": "past perfect",
  ...
  "videos.empty": "No videos watched yet. Complete a video exercise to add it here.",
  "videos.count": "{n} videos watched",
  "videos.day": "Day {day}",
  "videos.replay": "Replay",
  "videos.markSeen": "Mark as seen",
  "videos.watchToEnd": "Watch to the end…",
  "videos.seen": "Seen",
  "videos.quizTitle": "Video comprehension check",
  "videos.score": "{correct}/{total} correct — review and try again",
  "videos.retry": "Retry",
  "videos.submit": "Submit answers",
  "videos.complete": "Video complete!",
  "videos.completeMsg": "You watched and completed the exercise. +20 XP!",
...
const fr: Record<StringKey, string> = {
  ...
  "verbs.title": "Exercice 2 · Verbes irréguliers",
  "verbs.hint": "Complétez : {infinitive} ({translation})",
  "verbs.check": "Vérifier",
  "verbs.next": "Suivant",
  "verbs.nice": "Correct !",
  "verbs.correctAnswer": "Bonne réponse",
  "verbs.perfect": "Parfait !",
  "verbs.tryAgain": "Presque",
  "verbs.summary": "{correct} / {total} correct",
  "verbs.again": "Réessayer",
  "verbs.continue": "Continuer",
  "verbs.noPool": "Pas encore de verbes — revenez demain.",
  "verbs.tense.present": "présent",
  "verbs.tense.past": "passé",
  "verbs.tense.pastParticiple": "participe passé",
  "verbs.tense.future": "futur",
  "verbs.tense.presentPerfect": "present perfect",
  "verbs.tense.pastPerfect": "past perfect",
  ...
  "videos.empty": "Aucune vidéo regardée. Terminez un exercice vidéo pour l'ajouter ici.",
  "videos.count": "{n} vidéos regardées",
  "videos.day": "Jour {day}",
  "videos.replay": "Revoir",
  "videos.markSeen": "Marquer comme vu",
  "videos.watchToEnd": "Regardez jusqu'à la fin…",
  "videos.seen": "Vu",
  "videos.quizTitle": "Vérification de compréhension",
  "videos.score": "{correct}/{total} correct — révisez et réessayez",
  "videos.retry": "Réessayer",
  "videos.submit": "Valider les réponses",
  "videos.complete": "Vidéo terminée !",
  "videos.completeMsg": "Vous avez regardé et terminé l'exercice. +20 XP !",
...
const zh: Record<StringKey, string> = {
  ...
  "step.reading": "阅读",
  "verbs.title": "练习 2 · 动词",
  "verbs.hint": "填空：{infinitive}（{translation}）",
  "verbs.check": "检查",
  "verbs.next": "下一个",
  "verbs.nice": "正确！",
  "verbs.correctAnswer": "正确答案",
  "verbs.perfect": "完美！",
  "verbs.tryAgain": "差一点",
  "verbs.summary": "{correct} / {total} 正确",
  "verbs.again": "再试一次",
  "verbs.continue": "继续",
  "verbs.noPool": "还没有动词——明天再来。",
  "verbs.tense.present": "现在",
  "verbs.tense.past": "过去（了）",
  "verbs.tense.pastParticiple": "经历（过）",
  "verbs.tense.future": "将来（会）",
  "verbs.tense.presentPerfect": "已经",
  "verbs.tense.pastPerfect": "过去完成",
  ...
  "videos.empty": "还没有看过的视频。完成视频练习即可在此回看。",
  "videos.count": "已观看 {n} 个视频",
  "videos.day": "第 {day} 天",
  "videos.replay": "重看",
  "videos.markSeen": "标记为已看",
  "videos.watchToEnd": "请看到结尾…",
  "videos.seen": "已看",
  "videos.quizTitle": "视频理解测验",
  "videos.score": "{correct}/{total} 题正确 — 复习后再试",
  "videos.retry": "重试",
  "videos.submit": "提交答案",
  "videos.complete": "视频完成！",
  "videos.completeMsg": "你已观看并完成练习。+20 经验值！",
  "menu.session": "每组卡片数",
